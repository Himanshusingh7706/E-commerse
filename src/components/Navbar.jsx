...
const Navbar = ({ setData, cart, isAuth, setIsAuth }) => {
      ...
      <header className='sticky-top'>
        <div className="nav-bar">
          ...
          <div className='log-in'>
            {isAuth ? <button onClick={logoutHandler}>Logout</button> : <button className='log-in' onClick={() => navigate("/login")}>Login</button>}
          </div>
